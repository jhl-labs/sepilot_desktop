...
- **Markdown 파일에서 클립보드 이미지 붙여넣기 기능**
  ...
  - **자동 저장**: 클립보드 이미지를 working directory에 자동 저장 (clipboard-{timestamp}.png)
  ...
  - **편리한 워크플로우**: 스크린샷 → Ctrl+V → 즉시 문서에 삽입
  - 코드 위치:
    - IPC 핸들러: `electron/ipc/handlers/file.ts:1000-1041`
    - 클라이언트: `components/editor/Editor.tsx:820-893`
