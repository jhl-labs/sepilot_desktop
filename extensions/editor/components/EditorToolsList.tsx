...
import type { ToolCategory, CategoryMeta } from '@/extensions/editor/tools/editor-tools-registry';
...
export function EditorToolsList({
  ...
  const loadTools = async () => {
    ...
    try {
      ...
      const { editorToolsRegistry, getAllCategories } =
        await import('@/extensions/editor/tools/index');
      const { registerAllEditorTools } = await import('@/extensions/editor/tools/index');
