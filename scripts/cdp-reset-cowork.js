...
async function main() {
  ...
  console.log('[CDP] Resetting cowork state...');
  ...
  const result = await cdpEval(
    ...
    (function() {
      ...
      // Reset cowork state
      if (typeof s.resetCoworkState === 'function') {
        s.resetCoworkState();
      }
      ...
      return JSON.stringify({
        success: true,
        coworkPlan: newState.coworkPlan,
        coworkTeamStatus: newState.coworkTeamStatus,
        taskResults: newState.taskResults,
