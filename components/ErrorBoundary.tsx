          ...
          <Card className="max-w-2xl w-full border-destructive">
            ...
            <CardContent className="space-y-4">
              ...
              {this.state.isReporting && (
                <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-3 text-sm text-blue-600 dark:text-blue-500">
                  에러를 자동으로 리포트하고 있습니다...
                </div>
              )}
