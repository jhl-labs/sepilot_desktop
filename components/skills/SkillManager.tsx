            ...
            <TableBody>
              {skills.map((skill) => (
                <TableRow key={skill.id}>
                  ...
                  {/* 카테고리 */}
                  <TableCell>
                    <Badge variant="secondary" className={cn('text-xs', getCategoryColor(skill.manifest.category))}>
      ...
      <AlertDialog open={deleteDialog.open} onOpenChange={(open) => setDeleteDialog({ ...deleteDialog, open })}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              <span className="font-semibold">{deleteDialog.skillName}</span> 스킬을 제거하시겠습니까?
              <br />
              이 작업은 되돌릴 수 없습니다.
            </AlertDialogDescription>
          </AlertDialogHeader>
